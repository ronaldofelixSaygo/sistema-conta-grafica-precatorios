...
export async function createCliente(user, data) {
  ...
  return prisma.cliente.create({
    data: {
      ...
      escritorio: data.escritorio ? String(data.escritorio).trim() : null,
      ...
      percentualDeposito: toNumberOrNull(data.percentual_deposito ?? data.percentualDeposito) ?? 30,
...
export async function updateCliente(user, id, data) {
  ...
  return prisma.cliente.update({
    ...
    data: {
      ...
      ...(data.escritorio         !== undefined && { escritorio: data.escritorio ? String(data.escritorio).trim() : null }),
      ...
      ...((data.percentual_deposito ?? data.percentualDeposito) !== undefined && { percentualDeposito: toNumberOrNull(data.percentual_deposito ?? data.percentualDeposito) ?? 30 }),
